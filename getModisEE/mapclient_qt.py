...
class MapViewWidget(QtGui.QWidget):
    ...
    def __saveCurrentView(self):
        ...
        miscUtilities.downloadEeImage(overlayToSave.eeobject, current_view_bbox, scale, file_path, overlayToSave.vis_params)
    ...
    def addToMap(self, eeobject, vis_params=None, name="", show=True):
        ...
        with self.thread_lock:
            self.executing_threads.append(miscUtilities.waitForEeResult(functools.partial(execute_thread, list(self.executing_threads)),
